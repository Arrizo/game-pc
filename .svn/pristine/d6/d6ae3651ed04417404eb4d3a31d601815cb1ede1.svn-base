...
var LOCALSTORAGE_CLIENTID = 'clientId'
// var COOKIE_H5TOKEN = 'h5Token'
// var COOKIE_SDKTOKEN = 'sdkToken'
// var COOKIE_SDKUSERID = 'sdkUserId'
// var COOKIE_LOGINPLATFORM = 'loginPlatform'
...
CookieUtil.prototype.getDecryptH5TokenFromCookie = function (originH5Token) {
    ...
    //   if(!this.clientId){
      this.clientId = localStorage.getItem(LOCALSTORAGE_CLIENTID)
    //   }
